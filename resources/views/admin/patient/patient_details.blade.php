					...
					<div class="box">
						...
						<div class="box">
							<div class="box-header">
							  <h4 class="box-title">Emergency Contact Details</h4>
							...
							<div class="box-body">
							  <div class="flexbox bb-1 mb-15">
								<div><p><span class="text-mute">Contact Name:</span> <strong>{{$patient->emergency_contact_name}}</strong></p></div>
								<div><p><span class="text-mute">Contact No:</span> <strong>{{$patient->emergency_contact_phone}}</strong></p></div>
							  </div>
							
							</div>
						  <div class="box-body pt-0">
							<p><small>Created on {{$patient->created_at}}</small></p>
						  </div>
					...
					<div class="box">
						...
						<div class="box-body wed-up position-relative">
							<div class="d-md-flex align-items-center">
								...
								<div class="mt-40">
									<h4 class="fw-600 mb-5">{{$patient->first_name.' '. $patient->last_name}}</h4>
									<h5 class="fw-500 mb-5">#p- {{ $patient->id}}</h5>
									<p><i class="fa fa-clock-o"></i>{{$patient->date_of_birth}}</p>
								</div>
							</div>
						</div>
						<div class="box-body pt-0">
