				...
				<div class="col-lg-10 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Edit Patient Details</h4>
						</div>
						<!-- /.box-header -->
                        <form method="post" action="{{route('patient_edit')}}">
                            @csrf 
                            @method('PUT')
							<div class="box-body">
								...
								<div class="row">
								  <div class="col-md-4">
                                    <input type="hidden" class="form-control" name="pid" value="{{$patient->id}}">
                                  ...
                                  <div class="col-md-4">
									<div class="form-group">
                                      ...
                                      <select class="form-select" name="gender"  value="{{$patient->gender}}">
										<option>Male</option>
								...
								<div class="row">
								  ...
								  <div class="col-md-4">
									<div class="form-group">
									  ...
									  <input type="datetime-local" class="form-control" placeholder="date" name="date_of_birth"  value="{{$patient->date_of_birth}}">
									</div>
								  </div>
								</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="tel" placeholder="Contact Number" name="phone_number"  value="{{$patient->phone_number}}">
                                          </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Address</label>
                                            <input class="form-control" type="text" placeholder="Address" name="address"  value="{{$patient->address}}">
                                          </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select  class="form-select" name="county"  value="{{$patient->county}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="Town" name="town"  value="{{$patient->town}}">
                                          </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Postal Code</label>
                                            <input class="form-control" type="text" placeholder="Postal Code" name="postal_code"  value="{{$patient->postal_code}}">
                                          </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="Emergency Contact Name" name="emergency_contact_name"  value="{{$patient->emergency_contact_name}}">
                                          </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Emergency Contact Phone</label>
                                            <input class="form-control" type="tel" placeholder="Phone" name="emergency_contact_phone"  value="{{$patient->emergency_contact_phone}}">
                                          </div>
                                    </div>
