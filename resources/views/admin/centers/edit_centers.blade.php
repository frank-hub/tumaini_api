	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Diagnostic Centers</h4>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item active" aria-current="page">Diagnostic Centers</li>
							</ol>
						</nav>
					</div>
				</div>
            ...
            <div class="col-md-8">
                ...
                <div class="box">
                    <div class="box-header with-border">
                      <h4 class="box-title">Edit Diagnostic Center Info</h4>
                    </div>
                    <!-- /.box-header -->
                    <form method="POST" action="{{route('center_edit')}}">
                        @csrf
                        @method('PUT')
                        <div class="box-body">
                            <input type="hidden" class="form-control" name="cid" value="{{$center->id}}">
                            <div class="form-group">
                                <label class="form-label">Center Name:</label>
                                <input type="text" class="form-control" placeholder="Center name" name="name" value="{{$center->name}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Country:</label>
                                <input type="text" class="form-control" placeholder=" Country" name="country"  value="{{$center->country}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">City:</label>							
                                <input type="text" class="form-control" placeholder="City" name="city"  value="{{$center->city}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Description</label>

                                <textarea rows="4" class="form-control" placeholder="Description" name="description"  >{{$center->description}}</textarea>
                              </div>
