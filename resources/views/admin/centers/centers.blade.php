											...
											<td>
												<div class="btn-group">
												  ...
												  <div class="dropdown-menu">
													{{-- <a class="dropdown-item" href="{{url('center/patient_details')."/".$item->id}}">View Details</a> --}}
													<a class="dropdown-item"href="{{url('centers/edit')."/".$item->id}}">Edit</a>
													<a class="dropdown-item" href="{{url('centers/delete')."/".$item->id}}">Delete</a>
												  </div>
											    </div>
											</td>
										</tr>	
