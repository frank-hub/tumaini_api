				...
				<div class="col-lg-10 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Appointments Details</h4>
						</div>
						<!-- /.box-header -->
                        <form method="post" action="{{route('app_store')}}">
                            @csrf 
							<div class="box-body">
								...
								<div class="row">
								  <div class="col-md-4">
									...
									<div class="form-group">
									 ...
									 <select class="form-select" name="patient_id" id="">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="symptoms" name="symptoms">
                                          </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Severity of The Desease</label>
                                            <select  class="form-select" name="severity_desease">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="center" id="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="2" class="form-control" placeholder="Appointment Reasons" name="appointment_reason"></textarea>
                                      </div>
                                    <div class="form-group">
                                        <label class="form-label">Additional Notes</label>
                                        <textarea rows="4" class="form-control" placeholder="Additional Notes" name="notes"></textarea>
                                      </div>
